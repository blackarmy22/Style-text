...
# Render's free/standard Web Service type expects the app
# to bind to a port. This tiny Flask app just answers "OK"
# on "/" so Render sees the service as healthy, while the
# actual Telegram bot keeps polling in the background.
# =========================================================
...
# BOT TOKEN
#
# SECURITY NOTE: don't hardcode the token in the source.
# On Render, set it as an Environment Variable named
# BOT_TOKEN in the dashboard, and read it like this:
# =========================================================
...
def main():
    ...
    # This keeps Render's Web Service happy (it needs a
    # port bound) while the bot itself runs polling below.
    # -----------------------------------------------------
    threading.Thread(
        target=run_flask,
        daemon=True,
