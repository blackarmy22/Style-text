...
@app.route("/")
def home():
    return "English Style Font Bot is running!", 200
...
# BOT TOKEN
# =========================================================
BOT_TOKEN = "8911957472:AAHIz2J0vf0yp_Ix7gK6cUIFe0xcKy6FXqM"

# =========================================================
# FORCE JOIN CHANNEL
# =========================================================
CHANNEL_ID = "@technology_kurdishB"
CHANNEL_LINK = "https://t.me/technology_kurdishB"
...
def main():
    ...
    # Start Flask so the bot can run as a Render Web Service.
